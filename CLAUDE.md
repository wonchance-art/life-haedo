...
가정 80/100 토글(기본 80) · 범위 All/20Y/10Y/5Y/1Y · 표시 시대/사건/오늘/축.

**배치는 고르지 않는다 — 화면 비율에서 자동으로 나온다.**
- 줄바꿈: 한 줄에 담을 년(또는 달) 수 k = √(가로÷세로 × 총주기 ÷ 한주기열)
- 눕힘: 후보 5개(연×52·연×26·연×13·달×31·주×7) 중 화면을 가장 넓게 덮는 것

앱 오버레이 1224×470 실측:

| 범위 | 줄바꿈 | 눕힘 |
|---|---|---|
| All | 104×40 · 10.5px · 89% | 80×26 · 14.7px · 96% |
| 20Y | 52×20 · 21.0px · 89% | 20×13 · 33.4px · 55% |
| 10Y | 52×10 · 21.0px · 89% | 120×31 · 9.8px · 96% |
| 5Y | 62×30 · 15.5px · 78% | 60×31 · 14.0px · 69% |
| 1Y | 31×12 · 35.2px · 89% | 52×7 · 22.7px · 96% |

눕힘은 가로가 시간축이라 연표와 같은 방향(시대=위 띠, 나이=아래 축, 지난 칸이 왼쪽).
줄바꿈은 어느 범위에서나 폭 78~89%로 고르다.

미결: ① 앱 이식 여부 ② 기본 방향(줄바꿈/눕힘) ③ 자리(오버레이/별도 화면).
